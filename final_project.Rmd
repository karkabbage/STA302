...
valid_data$PTRATIO <- cos(sin(valid_data$PTRATIO))
valid_data$NOX <- sin((valid_data$NOX))
valid_data$ZN <- (cos(valid_data$ZN))
valid_data$INDUS <- sqrt(valid_data$INDUS)
valid_data$B <- log(valid_data$B)
valid_data$CRIM <- cos(log(valid_data$CRIM))**2
...
# Perform ANOVA on each model
anova_model_v <- anova(model_v)
anova_model_no_outliers_v <- anova(model_v_no_outliers)
anova_model_after_vif_v <- anova(model_after_vif_v)
anova_model_after_vif_no_outliers_v <- anova(model_after_vif_no_outliers_v)
anova_model_step.model1_v <- anova(step.model1_v)
anova_model_step.model2_v <- anova(step.model2_v)
anova_model_step.model3_v <- anova(step.model3_v)
anova_model_step.model4_v <- anova(step.model4_v)
...
anova_stats_model_v <- extract_anova_stats(anova_model_v, "Original Model")
anova_stats_model_no_outliers_v <- extract_anova_stats(anova_model_no_outliers_v, "Model No Outliers")
anova_stats_model_after_vif_v <- extract_anova_stats(anova_model_after_vif_v, "Model After VIF")
anova_stats_model_after_vif_no_outliers_v <- extract_anova_stats(anova_model_after_vif_no_outliers_v, "Model After VIF No Outliers")
anova_stats_model_step.model1_v <- extract_anova_stats(anova_model_step.model1_v, "Model 1 Anova Step Model")
anova_stats_model_step.model2_v <- extract_anova_stats(anova_model_step.model2_v, "Model 2 Anova Step Model")
anova_stats_model_step.model3_v <- extract_anova_stats(anova_model_step.model3_v, "Model 3 Anova Step Model")
anova_stats_model_step.model4_v <- extract_anova_stats(anova_model_step.model4_v, "Model 4 Anova Step Model")

# Combine all ANOVA stats into one data frame
combined_anova_stats_v <- rbind(anova_stats_model_v, anova_stats_model_no_outliers_v, anova_stats_model_after_vif_v, anova_stats_model_after_vif_no_outliers_v, anova_stats_model_step.model3_v, anova_stats_model_step.model1_v, anova_stats_model_step.model2_v, anova_stats_model_step.model4_v)

# Categorize by Model
combined_anova_stats_v <- combined_anova_stats_v %>% arrange(Model, `Pr(>F)`)

# Display the categorized ANOVA stats
print(combined_anova_stats_v)
...
model_metrics_v <- bind_rows(
  ...
  get_model_metrics(step.model1_v, "anova_stats_model_step.model1"),
  get_model_metrics(step.model2_v, "anova_stats_model_step.model2"),
  get_model_metrics(step.model3_v, "anova_stats_model_step.model3"),
  get_model_metrics(step.model4_v, "anova_stats_model_step.model4")
