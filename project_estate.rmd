...
df_selected <- sampled_df %>%
 select(houseAge, distanceMRTStation, noConvenienceStores, housePriceUnitArea) 
...
model <- lm(housePriceUnitArea ~ houseAge + distanceMRTStation + noConvenienceStores, data = df_selected)
